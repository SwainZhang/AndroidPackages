package com.emery.test.androidpackages;
...
import com.emery.test.androidpackages.cache.DoubleCache;
...
import com.emery.test.androidpackages.policy.SerialPolicy;
...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        builder.setDisplayDefaultImage(R.drawable.loading)
                .setDisplayErrorImage(R.drawable.not_found)
                .setIBitmapCache(new DoubleCache(this))
                .setILoaderPolicy(new SerialPolicy());
        ImageLoaderConfig config = builder.builder();
        //初始化imageloader
    ...
    class MyAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            //请求图片
            imageLoader.display(holder.imageview, imageThumbUrls[position]);
            return convertView;
        }
    }
    ...
    private boolean requestInternet() {
        ...
        if (shouldShowRequestPermissionRationale(INTERNET)) {
            Snackbar.make(mGridView, "需要获取网络权限", Snackbar.LENGTH_INDEFINITE)
